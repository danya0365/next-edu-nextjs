...
export const enrollments: Enrollment[] = [
  ...
  // Enrollments for user-stud-001 (from authStore mock user)
  {
    id: 'enroll-004',
    courseId: 'course-001',
    studentId: 'user-stud-001',
    progress: 45,
    completedLessons: ['lesson-001', 'lesson-002'],
    currentLessonId: 'lesson-003',
    lastAccessedAt: '2025-10-14T08:00:00Z',
    status: 'active',
    certificateIssued: false,
  ...
  },
  {
    ...
    progress: 100,
    completedLessons: ['lesson-010', 'lesson-011', 'lesson-012'],
    lastAccessedAt: '2025-10-01T00:00:00Z',
    status: 'completed',
    certificateIssued: true,
  ...
  },
  {
    ...
    studentId: 'user-stud-001',
    progress: 20,
    completedLessons: ['lesson-031'],
    currentLessonId: 'lesson-032',
    lastAccessedAt: '2025-10-13T00:00:00Z',
    status: 'active',
    certificateIssued: false,
    enrolledAt: '2025-10-05T00:00:00Z',
  },
];
